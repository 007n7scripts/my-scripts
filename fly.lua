...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "ProjectKeyFly-6190768" then   
screenGui:Destroy()
 
loadstring(game:HttpGet("https://raw.githubusercontent.com/007n7scripts/FlyGuiScript/refs/heads/main/FlyGUIV3.lua"))()
